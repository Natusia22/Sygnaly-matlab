...
filter_type = 'high-pass'; % Typ filtra: low-pass, high-pass, band-pass
...
function design_filter(fpr, f0, M, filter_type, wp, wt, ws)
    ...
    elseif strcmp(filter_type, 'band-pass')
        ...
        Ad = [ zeros(1,band_center-band_width/2) ones(1,band_width) zeros(1,P-band_center-band_width/2-band_width) ];
    else
